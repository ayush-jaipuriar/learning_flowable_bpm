...
@Component
@Slf4j
public class StartLoanModificationDelegate implements JavaDelegate {
    ...
    public void execute(DelegateExecution execution) {
        ...
        log.info("Starting loan modification case for loan application ID: {}", loanApplicationId);
        
        // Use the existing service method to start the CMMN case
        getLoanApplicationService().handleLoanModification(loanApplicationId);
        
        // Set a variable to track that a case has been started
        execution.setVariable("modificationCaseStarted", true);
    }
} 