...
@Component
@Slf4j
public class StartCustomerInquiryDelegate implements JavaDelegate {
    ...
    public void execute(DelegateExecution execution) {
        ...
        log.info("Starting customer inquiry case for loan application ID: {}", loanApplicationId);
        
        // Use the existing service method to start the CMMN case
        getLoanApplicationService().handleCustomerInquiry(loanApplicationId);
        
        // Set a variable to track that a case has been started
        execution.setVariable("inquiryCaseStarted", true);
    }
} 